...
* Date time picking without value (i.e. default = None). This applies for optional fields whos value the user might want to leave out.

`Source code available at github <http://github.com/davisagli/collective.z3cform.datepicker>`_.
